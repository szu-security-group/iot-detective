...
BLACK_IPS = ["192.168.1.1", "192.168.1.180", "192.168.1.208", "192.168.1.228", "192.168.1.243", "192.168.1.248",
             "192.168.1.239", ":1", ":2"]
...
THETA_STEP = 0.002
THETA_STR_LENGTH = 5
TOTAL_IPS_DEVICES_INFO_FILE = os.path.join(os.path.join("train_data", "finder_08_500000.json"))
...
LABEL_DATA_FOLDER_NAME = "label_data"
LABEL_RESULT_FOLDER_NAME = "label_result"

# 标识集
LABEL_TARGET_NAME = "finder_08_last_14_days"
...
# 需要测试的测试集
# TEST_TARGET_NAME = "finder_09_20000"
# TEST_TARGET_NAME = "finder_09_100000"
TEST_TARGET_NAME = "arunan_dns_1"
# TEST_TARGET_NAME = "long_dns_901_1192"

# 候选的测试集
# TEST_TARGET_NAME = "long_dns_2972_3665"
# TEST_TARGET_NAME = "lazy_dns"
# TEST_TARGET_NAME = "long_dns_111010"
...
# 存放总的结果
ALL_RESULT_FOLDER_NAME = "all_result"
